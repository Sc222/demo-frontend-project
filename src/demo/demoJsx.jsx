...
class Foo extends React.Component implements BazService, QuuxProvider {}
...
var foo = {
    ...
    fOne: function (a, b, c, d, e, f, g, h) {
        ...
        this.fTwo(a, b, c, this.fThree(d, e, f, g, h));
    ...
    fTwo: function (a, b, c, d) {
        this.fTwo(a, b, c, d); // Line comment which can be wrapped if long.
        if (true) return c;
